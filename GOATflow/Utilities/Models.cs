...
namespace GOATflow.Models
{
    ...
    /// Matches CatalogueItemDTO (merchant-facing, active only)
    ...
    /// Matches AdminCatalogueItemDTO (admin/manager, all products)
    ...
    // ════════════════════════════════════════════════════════════════════════
    // BASKET (local C# state only — never serialised from API)
    // ════════════════════════════════════════════════════════════════════════

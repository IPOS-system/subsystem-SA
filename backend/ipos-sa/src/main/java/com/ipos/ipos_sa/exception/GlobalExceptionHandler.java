 ...
 * Catches all custom exceptions and Spring validation errors, returning
 * a consistent ApiErrorResponse JSON body so the C# frontend can parse
 * errors uniformly.
 */
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    /**
     * Catch-all for any unexpected exception so the frontend never sees
     * a raw Spring error page or stack trace.
     */

...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
  ...
  /**
   * Sum of all payments recorded against a specific invoice. Used by PaymentService to calculate
   * the remaining outstanding balance after each new payment is recorded.
   */
  @Query(

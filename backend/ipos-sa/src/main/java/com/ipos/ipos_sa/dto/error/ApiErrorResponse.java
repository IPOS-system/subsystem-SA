...
/**
 * Standard error response body returned by GlobalExceptionHandler. Every non-2xx response from the
 * API will have this shape, making it straightforward for the C# frontend to parse and display
 * error messages.
 *
 * <p>Example: { "timestamp": "2026-04-01T14:32:00", "status": 403, "error": "ORDER_REJECTED",

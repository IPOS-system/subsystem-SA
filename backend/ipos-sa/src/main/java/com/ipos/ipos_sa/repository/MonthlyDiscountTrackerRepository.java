...
public interface MonthlyDiscountTrackerRepository
  ...
  /**
   * Find the tracker record for a specific merchant and calendar month. yearMonth format: "YYYY-MM"
   * e.g. "2026-03". Used to accumulate order values and calculate flexible discount at month-end.
   */

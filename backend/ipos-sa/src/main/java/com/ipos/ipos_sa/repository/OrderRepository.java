...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    /**
     * RPT-01 (Turnover): quantity sold per product in a date range.
     * Returns Object[] rows of [productId, description, totalQty, totalRevenue].
     */
    @Query("SELECT oi.catalogueItem.productId, oi.catalogueItem.description, " +
    ...
    List<Object[]> findProductSaleTotalsBetween(@Param("from") LocalDateTime from,
                                                @Param("to")   LocalDateTime to);

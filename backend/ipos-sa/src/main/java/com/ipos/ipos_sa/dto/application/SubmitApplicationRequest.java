 ...
 *
 * Maps to the CommercialApplicationForm defined in the Deliverable 1
 * ICMAAPI interface. Submitted by IPOS-PU when a member of the public
 * applies for a commercial membership.
 */
@Data

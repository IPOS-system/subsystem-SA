...
public class CatalogueItem {
     ...
     * When current_availability < min_stock_level the item is flagged as low-stock.
     * The recommended reorder quantity brings availability to (min_stock_level * (1 + reorder_buffer_pct)).
     */

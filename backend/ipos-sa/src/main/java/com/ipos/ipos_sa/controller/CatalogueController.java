 ...
 *
 * <p>Role rules: GET /api/catalogue → any authenticated user (merchants browse here) GET
...
public class CatalogueController {
  ...
  /** POST /api/catalogue Adds a new product to the catalogue (UC-10). */
  @PostMapping
  ...
  /**
   * PUT /api/catalogue/{id} Updates product details (UC-11). Partial update — only non-null fields
   * applied.
   */
  @PutMapping("/{id}")
  ...
  /**
   * PUT /api/catalogue/{id}/deactivate Soft-deletes a product (UC-12). Product disappears from
  ...
  /** POST /api/catalogue/{id}/stock Records a stock delivery — increases availability (UC-34). */

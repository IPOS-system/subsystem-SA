 ...
 *
 * <p>Inter-subsystem: IPOS-PU calls POST /api/applications/commercial to submit a commercial
 * membership application (submitCA).
 *
...
public class ApplicationController {
  ...
  public ResponseEntity<CommercialApplicationDTO> approveApplication(
    ...
    // Send approval email via PU's SMTP service (best-effort — failure does not block approval)
  ...
  public ResponseEntity<CommercialApplicationDTO> rejectApplication(
    ...
    // Send rejection email via PU's SMTP service (best-effort)

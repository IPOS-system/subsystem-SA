 ...
 *
 * <p>When a member of the public applies through the online platform as a "commercial" customer,
 * IPOS-PU sends the application to IPOS-SA via the submitCA() interface method. The application is
 * stored here for review by an Administrator.
 */
@Entity

...
/**
 * RPT-04: Invoice list for a specific merchant within a date range.
 * RPT-05: All invoices across all merchants within a date range.
 *
 * Both reports share the same structure — RPT-04 is merchant-scoped,
 * RPT-05 has merchantId/merchantName populated on each line.
 *
 * Returned by:

...
/**
 * Request body for POST /api/accounts/merchant. All required fields must be present — the account
 * will not be created if any are missing, per the brief (IPOS-SA-ACC).
 */
@Data

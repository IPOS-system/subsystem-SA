 ...
 * Contact details as header, then all orders with full line item breakdown.
 * Matches the layout in Appendix 5 of the brief.
 * Returned by GET /api/reports/merchant-detailed?merchantId=&from=&to=
 */
@Data
@Builder

...
/**
 * RPT-02: Merchant orders summary report.
 * List of orders for a specific merchant within a date range, with a totals row.
 * Matches the layout in Appendix 4 of the brief.
 * Returned by GET /api/reports/merchant-summary?merchantId=&from=&to=
 */
@Data
@Builder

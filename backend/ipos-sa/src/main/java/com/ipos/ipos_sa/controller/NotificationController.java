 ...
 *
 * <p>Called by the C# frontend on dashboard startup (Admin and Manager dashboards) to display
 * warning banners without the user having to navigate to individual screens.
 *
 * <p>Per the SA-APPLICATION plan: - Admin dashboard: low-stock warnings - Manager dashboard:
 * low-stock warnings + in-default merchant account warnings
 *
 * <p>Role rules: GET /api/notifications → ADMIN, MANAGER
 */
@RestController
...
public class NotificationController {
   ...
   *
   * <p>Response includes: - lowStockWarning: true if any active product is below its min stock

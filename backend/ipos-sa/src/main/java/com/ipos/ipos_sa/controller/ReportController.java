 ...
 *
 * All reports are MANAGER-only unless otherwise noted. ADMIN also has access for operational
 * convenience.
 *
 */
@RestController
...
public class ReportController {
   ...
   * all orders with line item breakdown.
   */
   ...
   * Returns FIRST reminders (1–15 days overdue) and SECOND reminders (15+ days overdue).
   * ADMIN, MANAGER, and ACCOUNTANT roles can generate reminders.
   */

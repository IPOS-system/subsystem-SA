...
/**
 * Request body for POST /api/discount-plans/flexible.
 * Creates a tiered discount plan where the rate depends on total monthly spend.
 *
 * Example tiers from the brief:
 *   1% for orders under £1000
 *   2% for orders £1000–£2000
 *   3% for orders over £2000
 *
 * The last tier should have maxOrderVal as null to represent "no upper limit".
 */
@Data

...
/**
 * Represents a merchant (pharmacy / retail client) registered in IPOS-SA. A merchant is linked to
 * exactly one User and may be assigned a DiscountPlan.
 *
 * <p>Account states: NORMAL – active; orders accepted. SUSPENDED – payment 15–30 days overdue; no
 * new orders. IN_DEFAULT – payment > 30 days overdue; requires Director authorisation to restore.
 */
@Entity

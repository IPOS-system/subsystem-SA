...
public class CatalogueService {
  ...
  /**
   * Normalizes a product ID by replacing hyphens with spaces. The database stores IDs as "100
   * 00001" (spaces) but the SA Endpoint Reference docs show "100-00001" (hyphens). This helper
   * ensures both formats are accepted by all endpoints.
   */

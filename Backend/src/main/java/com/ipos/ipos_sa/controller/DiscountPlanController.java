...
public class DiscountPlanController {
  ...
  /** POST /api/discount-plans/fixed Creates a fixed-rate discount plan. */
  @PostMapping("/fixed")
  ...
  /** POST /api/discount-plans/flexible Creates a tiered (flexible) discount plan. */
  ...
  /**
   * DELETE /api/discount-plans/{id} Deletes a discount plan by ID.
   */
  @DeleteMapping("/{id}")

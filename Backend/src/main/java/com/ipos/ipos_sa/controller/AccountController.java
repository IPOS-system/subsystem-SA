 ...
 *
 * Role rules enforced here: GET merchants / staff → ADMIN, MANAGER POST merchant account → ADMIN
...
public class AccountController {
  ...
  /**
   * PUT /api/accounts/merchants/{id}/restore Restores a merchant from IN_DEFAULT to NORMAL. ADMIN, MANAGER, and DIRECTOR can do this.
   */

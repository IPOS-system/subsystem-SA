...
public class AccountService {
  ...
  /**
   * Creates a new staff account (only admin)
   *
   ...
   *
   * Called on every merchant login and before every order placement. Does nothing if the account
  ...
  public void checkAndUpdateAccountStatus(Integer merchantId) {
    ...
    // IN_DEFAULT can only be cleared manually
    if (merchant.getAccountStatus() == Merchant.AccountStatus.IN_DEFAULT) {
      return;
    }
  ...
  /** Returns all non-merchant (staff) users. */
